        ...
        <div class="row g-3 align-items-center">
            <div class="d-flex align-items-center justify-content-between gap-1 mobile-erp">
                <div class=" col-md-4 mr-4  d-flex gap-2">
                    <a href="{{ route('pdf.download', ['type' => 'itiraz']) }}" class="btn btn-outline-dark"><i
                            class="fa-solid fa-file-pdf"></i> </a>
                    <button data-bs-toggle="modal" data-bs-target="#itiraztakipfilexcelmodal"
                ...
                <button type="button" style="border-radius: 3px" class="btn btn-warning btn-sm mx-0 mx-lg-2" data-bs-toggle="modal"
