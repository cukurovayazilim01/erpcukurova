            ...
            <div class="col">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    ...
                    <div class="col-lg-4 col-4 col-md-4 mr-4">
                        <a href="{{route('cariler.index')}}" type="button" class="btn btn-sm btn-outline-primary">
                            <i class="fa-solid fa-user"></i> Müşteriler
                        </a>
                        <a href="{{route('tedarikciler')}}" type="button" class="btn btn-sm btn-success">
            ...
            <form id="add-form" action="{{ route('cariler.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">Firma Kayıt Ekranı</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group input-with-icon">
                                        ...
                                        <input type="number" name="tc_kimlik" id="tc_kimlik"
                                            class="form-control form-control-sm" >
                                    </div>
                                </div>
                                <div class="col-md-6">
