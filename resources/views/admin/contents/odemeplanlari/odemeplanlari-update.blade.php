                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-with-icon">
                                    ...
                                    <input type="text" name="odeme_tutar" id="odeme_tutar"
                                        class="form-control form-control-sm" required value="{{$odemeplanlariitem->tahsilat_tutar}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-with-icon">
                                    ...
                                    <select name="durum" id="durum"
                                        ...
                                        <option value="Edildi"{{ $odemeplanlariitem->durum == 'Edildi' ? 'selected' : '' }}>Tahsil Edildi</option>
                                        <option value="Edilmedi"{{ $odemeplanlariitem->durum == 'Edilmedi' ? 'selected' : '' }}>Tahsil Edilmedi</option>
                                    </select>
                                </div>
                            </div>
