...
<div class="card">
        ...
        <div class="row g-3 align-items-center">
            <div class="col">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    ...
                    <div class="ms-auto">
                        <button type="button" class="btn btn-sm btn-outline-primary px-5" data-bs-toggle="modal" data-bs-target="#cekseneteklemodal">
    ...
    <div class="modal fade" id="cekseneteklemodal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <form id="add-form" action="{{ route('ceksenet.store') }}" method="POST" enctype="multipart/form-data" id="add-form">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group input-with-icon">
                                        ...
                                        <select name="cek_tipi" id="cek_tipi"
                        ...
                        @foreach ($ceksenet as $sn => $ceksenetitem)
                            <tr>
                                ...
                                <td>@if ($ceksenetitem->cek_tipi === 'Gelen' && $ceksenetitem->durum === '0')
                                    <a href="{{ route('cektahsilat', $ceksenetitem->id) }}" class="btn btn-sm bg-danger text-white text-decoration-none">
                                        Çek Tahsilatı
                                    </a>
                                    ...
                                    <a href="{{ route('cekodeme', $ceksenetitem->id) }}" class="btn btn-sm bg-success text-white text-decoration-none">
                                        Çek Ödemesi
                                    </a>
                                ...
                                <td class="text-right">
                                    <div class="databutton">
                                        <div class="d-flex align-items-center fs-6">
                                            ...
                                            data-bs-target="#ceksenetupdateModal-{{ $ceksenetitem->id }}"><i
                                                class="bi bi-pencil-fill"></i></button>
                                        @include('admin.contents.ceksenet.ceksenet-update')
                                            <form action="{{ route('ceksenet.destroy', ['ceksenet' => $ceksenetitem->id]) }}"
