...
<head>
    ...
    <title>{{$personel->ad_soyad}} - Özlük Dosyası</title>
 ...
 ============================== -->
    ...
    @media print {
      ...
      width: 860px;
            ...
            .invoice-table td b {
            color: black !important; /* Adres ve IBAN yazılarının siyah olması */
        }
    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-md-4">
            <div class="header-logo">
                <a href="#"><img src="{{asset('logintemp/cukurovalogo.png')}}" alt="Logo"></a>
            </div>
        </div>

        <!-- Ortada bilgiler -->
        <div class="col-md-4 text-center">
            <h1 class="big-title" style="color: #000; text-align: center;">PERSONEL ÖZLÜK DOSYASI</h1>
            {{-- <p class="invoice-number"><b>Doküman No: </b>FR-01</p>
            <p class="invoice-number"><b>Yayın Tarihi: </b>{{$personel->islem_tarihi}}</p>
            <p class="invoice-number"><b>Revizyon No: </b>00</p>
            <p class="invoice-number"><b>Revizyon Tarihi: </b>00</p> --}}
        </div>

        <!-- Sağ tarafa personel resmi -->
        <div class="col-md-4 text-center">
            <div class="header-logo">
                <a href="#">
                    <img src="{{$personel->personel_resim}}" style="width: 100px; height: 100px; object-fit: contain;" alt="Personel Resmi">
                </a>
            </div>
        </div>
    </div>
                        ...
                        <table class="invoice-table style3"
                            style="width: 100%; table-layout: fixed; border-collapse: collapse; border: 1px solid #ddd;">
                            <thead>
                                <tr>
                                    <th colspan="4"
                                        style="text-align: center; background-color: #616161; color: white;">Personel Bilgileri</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- <tr>
                                    <td
                                        style="text-align: center; width: 25%; border: 1px solid #ddd; background: #adadad">
                                        <strong style="font-size: 10px;">BELKİ BİSEY YAZARI< <br> </strong>
                                    </td>
                                    <td
                                        style="text-align: center; width: 25%; border: 1px solid #ddd; background: #adadad">
                                        <strong style="font-size: 10px;">BELKİ BİSEY YAZARI< <br> </strong>
                                ...
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Ad Soyad: <br> </strong> {{$personel->ad_soyad}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">T.C Kimlik No: <br> </strong> {{$personel->tc}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Doğum Tarihi: <br> </strong> {{$personel->dogum_tarihi}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Doğum Yeri: <br> </strong> {{$personel->dogum_yeri}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Telefon: <br> </strong> {{$personel->gsm}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Sabit Telefon: <br> </strong> {{$personel->ev_gsm}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">E-Posta: <br> </strong> {{$personel->mail}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Kan Grubu: <br> </strong> {{$personel->kan_grubu}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Son Mezun Olduğu Okul: <br> </strong>{{$personel->okul}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Mesleği: <br> </strong> {{$personel->meslegi}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Departman: <br> </strong> {{$personel->departman}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Mezuniyet: <br> </strong>{{$personel->mezuniyet}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Askerlik Durumu: <br> </strong> {{$personel->askerlik_durumu}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Medeni Hali: <br> </strong>{{$personel->medeni_hali}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Ayak No: <br> </strong> {{$personel->ayak_no}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Beden: <br> </strong> {{$personel->beden}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Ehliyet: <br> </strong> {{$personel->ehliyet_sinif}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Ehliyet Tarih: <br> </strong> {{$personel->ehliyet_tarihi}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Baba Adı: <br> </strong> {{$personel->baba_adi}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Baba Mesleği: <br> </strong> {{$personel->baba_meslegi}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Departman: <br> </strong> {{$personel->departman}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Kıdem Yılı: <br> </strong>{{$personel->kidem_yili}} </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Görevi: <br> </strong> {{$personel->gorevi}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Acil Durum: <br> </strong> {{$personel->acil_durum_kisi}}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">İşe Giriş Tarihi: <br> </strong> {{$personel->ise_giris_tarihi}}
                                    </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">İşten Çıkış Tarihi: <br> </strong> - </td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Sigorta Sicil No: <br> </strong> {{$personel->sigorta_sicil_no}}</td>
                                    <td style="text-align: center; width: 25%; border: 1px solid #ddd;"> <strong
                                            style="font-size: 10px;">Sigorta Giriş Tarihi: <br> </strong> {{$personel->sigorta_giris_tarihi}}</td>
                                </tr>
                            </tbody>
                        </table>

                        <table class="invoice-table table-style3 " style="background-color: #f3f3f3">
                            <tbody>
                                <tr>
                                    <td style="background-color: #616161; text-align: center"><b style="color: white">Adres:</b></td>
                                    <td colspan="3">{{$personel->ev_adresi}}</td>
                                </tr>
                                {{-- <tr>
                                    <td style="background-color: #616161; text-align: center"><b style="color: white">IBAN:</b></td>
                                    <td colspan="3">4545 454545454545
                                    </td>
                                </tr> --}}
                            </tbody>
                        </table>
                        <p class="table-title"><b>Personel Eğitim Kayıtları:</b></p>
                        <table class="invoice-table table-stripe4 theme-color">
                            <thead>

                                <tr>
                                    <th style="background-color: #616161; width: 15px">#</th>
                                    <th style="background-color: #616161;">Eğitim Adı</th>
                                    <th style="background-color: #616161;">Eğitim Tarihi</th>
                                    <th style="background-color: #616161;">Eğitim Süresi</th>
                                    <th style="background-color: #616161;">Eğitim Yeri</th>
                                    <th style="background-color: #616161;">Eğitim İçeriği</th>
                                    <th style="background-color: #616161;">Dosya</th>
                                </tr>

                            </thead>
                            <tbody>
                                @foreach ($personelegitim as $sn => $personelegitimitem)
                        ...
                        <p class="table-title"><b>Personel Zimmet Kayıtları:</b></p>
                        <table class="invoice-table table-stripe4 theme-color">
                            <thead>

                                <tr>
                                    <th style="background-color: #616161; width: 15px">#</th>
                                    <th style="background-color: #616161;">Zimmet Tarihi</th>
                                    <th style="background-color: #616161;">Marka</th>
                                    <th style="background-color: #616161;">Model</th>
                                    <th style="background-color: #616161;">Miktar/Birim</th>
                                    <th style="background-color: #616161;">Teslim Alındı Mı?</th>
                                </tr>

                            </thead>
                            <tbody>
                                @foreach ($personelzimmet as $zimmet)
                                @foreach ($zimmet->zimmetdata as $sn => $personelzimmetitem)
                                    <tr>
                                        <td>{{$sn + 1}}</td>
                                        <td>{{$personelzimmetitem->verilme_tarihi}}</td>
                                        <td>{{$personelzimmetitem->marka}}</td>
                                        <td>{{$personelzimmetitem->model}}</td>
                                        <td>{{$personelzimmetitem->miktar}} {{$personelzimmetitem->birim}}</td>
                                         @if (!empty($personelzimmetitem->geri_alma_tarihi))
                                        <td>Teslim Alındı</td>
                                        @else
                                        <td>Teslim Alınmadı</td>
                                        @endif
                                    </tr>
                                @endforeach
                            @endforeach
                        ...
                        <p class="table-title"><b>Personel İzin Kayıtları:</b></p>
                        <table class="invoice-table table-stripe4 theme-color">
                            <thead>
                                <tr>
                                    <th style="background-color: #616161; width: 15px">#</th>
                                    <th style="background-color: #616161;">Başlangıç Tarihi</th>
                                    <th style="background-color: #616161;">Bitiş Tarihi</th>
                                    <th style="background-color: #616161;">İzin Gün/Saat</th>
                                    <th style="background-color: #616161;">İzin Türü</th>
                                    <th style="background-color: #616161;">Açıklama</th>
                                    <th style="background-color: #616161;">Dosya</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($personelizin as $sn => $personelizinitem)
                                    <tr>
                                        <td>{{$sn + 1}}</td>
                                        <td>{{$personelizinitem->baslangic_tarihi}}</td>
                                        <td>{{$personelizinitem->bitis_tarihi}}</td>
                                        <td>{{$personelizinitem->izin_gun}}</td>
                                        <td>{{$personelizinitem->izin_turu}} </td>
                                        <td>{{$personelizinitem->izin_aciklama}} </td>
                                        <td>  <a href="{{route('izinler.show',['izinler'=>$personelizinitem->id])}}">İzin Formu</a></td>
                                    </tr>
                            @endforeach
                        ...
                        <div class="body-shape1">
                            <svg width="850" height="200" viewBox="0 0 850 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M850 0V200L770.414 66.0637L403.561 65.9779L377.479 45.3821L320 0H850Z" fill="#2D79F9" />
                            </svg>
                        </div>
                    </div>
