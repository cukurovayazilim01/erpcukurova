...
<head>
    ...
    <title>{{ $tahsilat->tahsilat_kodu_text }}-{{ $tahsilat->tahsilat_kodu }}-{{ $tahsilat->firmaadi->firma_unvan }} Tahsilat Fişi</title>
...
==============================-->
                        <header class="th-header header-layout4">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <h1 class="big-title">Tahsilat Fişi</h1>
                                    <p class="invoice-number"><b>Fiş No: </b>{{ $tahsilat->tahsilat_kodu_text }}-{{ $tahsilat->tahsilat_kodu }}</p>
                                    {{-- <p class="invoice-number"><b>satis No: </b>#935648</p> --}}
                                    <p class="invoice-number"><b>Fiş Tarihi: </b>{{ $tahsilat->tarih }}</p>
                                </div>
                            </div>
                        </header>
                        {{-- <hr class="style1"> --}}
                        <div class="row justify-content-between" style="margin-top: -16px">
                            ...
                            <div class="col-auto">
                                <div class="invoice-right">
                                    <b>Müşteri:</b>
                                    <address>
                                        {{ $tahsilat->firmaadi->firma_unvan }} <br>
                                        {{ $tahsilat->firmaadi->yetkili_kisi }} <br>
                                        {{ $tahsilat->firmaadi->yetkili_kisi_tel }} <br>
                                        {{ $tahsilat->firmaadi->eposta }}
                                    </address>
                                </div>
                            </div>
                        </div>
                        <hr class="style1">
                        <p class="table-title text-center"><b>Tahsilat:</b></p>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        {{ $tahsilat->odeme_tipi }}</td>
                                    <td style=" text-align: center;">
                                        {{ $tahsilat->odeme_turu }}</td>
                                    <td style=" text-align: center;">{{ $tahsilat->user->ad_soyad }}</td>
                                    <td style=" text-align: center;">{{ $tahsilat->odeme_yapan }}</td>
                                    <td>
                                        @if ($tahsilat->odeme_tipi === 'Banka')
                                            {{ $tahsilat->bankaadi->banka_adi }}
                                        @elseif($tahsilat->odeme_tipi === 'Kasa')
                                            {{ $tahsilat->kasaadi->kasa_adi }}
                                        @endif
                                    </td>
                                    <td style=" text-align: center;">{{number_format( $tahsilat->tahsilat_tutar, 2, ',', '.') }} ₺</td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="col-md-12">
                                <table class="total-table">
                                    <tr>
                                        ...
                                        <td>{{ number_format($tahsilat->satis_iskonto_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>TOPLAM KDV</th>
                                        <td>{{ number_format($tahsilat->satis_kdv_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>ARA TOPLAM</th>
                                        <td>{{ number_format($tahsilat->satis_ara_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>TOPLAM TUTAR</th>
                                        <td>{{ number_format($tahsilat->satis_kdvli_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                </table>
                            </div>
                        </div> --}}
            ...
            */
            ...
            $('#download_btn').on('click', function() {
                ...
                html2canvas(downloadSection[0], {
                    ...
                    var pdfUrl =
                        '{{ $tahsilat->tahsilat_kodu_text }}-{{ $tahsilat->tahsilat_kodu }}-{{ $tahsilat->firmaadi->firma_unvan }} Tahsilat Fişi.pdf';
                    pdf.save(pdfUrl);
                });
            });
