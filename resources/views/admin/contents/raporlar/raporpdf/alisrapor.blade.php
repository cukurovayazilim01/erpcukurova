...
==============================-->
                        <header class="th-header header-layout4">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <h1 class="big-title">Alış Rapor</h1>
                            ...
                            <div class="col-auto">
                                <div class="invoice-right">
                                    ...
                                    <address>
                                        ...
                                        {{ $alisrapor->first()->firmaadi->firma_unvan }}
                                        <br>
                                        {{ $alisrapor->first()->firmaadi->yetkili_kisi }}
                                        <br>
                                        {{ $alisrapor->first()->firmaadi->yetkili_kisi_tel }}
                                        <br>
                                        {{ $alisrapor->first()->firmaadi->eposta }}
                                        @endif
                        ...
                        <table class="invoice-table table-stripe4 theme-color">
                            ...
                            <tbody>
                                @foreach ($alisrapor as $sn => $alisraporitem)
                                    <tr>
                                        <td style=" text-align: center;"><strong>{{ $sn + 1 }}</strong></td>
                                        <td style=" text-align: center;"> <a
                                                href="{{ url('alislar/' . $alisraporitem->alis_id) }}" target="_blank">{{ $alisraporitem->alis->alis_kodu_text }}-{{ $alisraporitem->alis->alis_kodu }}</a>
                                        </td>
                                        <td style=" text-align: center;">{{ $alisraporitem->islem_tarihi }}</td>
                                        @if (!$cari_id)
                                            <td style=" text-align: center;">
                                                {{ $alisraporitem->firmaadi->firma_unvan }}
                                            </td>
                                        @else
                                        @endif
                                        <td style=" text-align: center;">
                                            {{ number_format($alisraporitem->alis->toplam_tutar, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    @php
                                        $alis_toplam += $alisraporitem->alis->toplam_tutar;
                                    @endphp
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <div class="col-md-12">
                                <table class="total-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($alis_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
