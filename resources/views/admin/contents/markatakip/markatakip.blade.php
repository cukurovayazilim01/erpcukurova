    ...
    <div class="card-header bg-transparent">
        <div class="row align-items-center g-3">
            ...
            <div class="col-md-9 text-end">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#markatakipfilexcelmodal"
                ...
                <button type="button" class="btn btn-sm btn-outline-primary px-5" style="margin-left: 10px"
                    data-bs-toggle="modal" data-bs-target="#markatakipmodal">
                        ...
                        @foreach ($markatakip as $markatakipitem)
                            <tr>
                                ...
                                <td class="text-wrap" style="max-width:100px">
                                    {{ $markatakipitem->hizmet->hizmet_ad }}</td>
