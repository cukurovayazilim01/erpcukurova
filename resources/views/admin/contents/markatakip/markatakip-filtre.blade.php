            ...
            <div class="row g-3 align-items-center">
                <div class="d-flex align-items-center justify-content-between gap-1 mobile-erp">
                    <div class=" col-md-4 mr-4  d-flex gap-2">
                        <a href="{{ route('markatakip.pdf') }}?{{ request()->getQueryString() }}" class="btn btn-outline-dark">
                            <i class="fa-solid fa-file-pdf" ></i>
                        </a>
                        <a href="{{ route('markatakip.excel') }}?{{ request()->getQueryString() }}" class="btn btn-outline-dark">
                        ...
                        <a href="javascript:;" onclick="customPrint()" class="btn btn-outline-dark">
