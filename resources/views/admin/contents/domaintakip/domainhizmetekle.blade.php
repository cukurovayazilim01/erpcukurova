                ...
                <div class="d-flex align-items-center justify-content-between gap-1 mobile-erp">
                    <div class="col-lg-4 ms-auto mobile-erp3 text-end">
                        <button type="button" class="btn btn-outline-dark btn-sm mx-0 mx-lg-2" data-bs-toggle="modal"
                            data-bs-target="#domainhizmeteklemodal"><i class="fa-solid fa-plus"></i>Yeni Ekle</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select name="domain_suresi" id="domain_suresi" class="form-control form-control-sm"
                                            required>
                                            <option value="">Seçim Yapınız</option>
                                ...
                                <div class="col-md-3" id="mail_platform_div" style="display: none;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select name="mail_platform" id="mail_platform" class="form-control form-control-sm">
                                ...
                                <div class="col-md-3" id="sunucu_div" style="display: none;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select name="sunucu" id="sunucu" class="form-control form-control-sm">
                                            <option value="">Seçiniz</option>
                                ...
                                <div class="col-md-3" id="vds_div" style="display: none;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select name="hosting_platform" id="vds" class="form-control form-control-sm">
                                            <option value="">Seçiniz</option>
