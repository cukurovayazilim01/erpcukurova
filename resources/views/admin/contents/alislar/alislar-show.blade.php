...
==============================-->
                        <header class="th-header header-layout4">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <h1 class="big-title">Alış Faturası</h1>
                                    <p class="invoice-number"><b>Fatura No: </b>{{$alislar->fis_no}}</p>
                                    {{-- <p class="invoice-number"><b>satis No: </b>#935648</p> --}}
                                    <p class="invoice-number"><b>Fatura Tarihi: </b>{{$alislar->fis_tarihi}}</p>
                                </div>
                            </div>
                        </header>
                        {{-- <hr class="style1"> --}}
                        ...
                        <hr class="style1">
                        <p class="table-title text-center"><b>Gider Listesi:</b></p>
                        <table class="invoice-table table-stripe4 theme-color">
                            ...
                            <tbody>
                                @foreach ($alislardata as $sn => $alislardataitem)
                                    <tr>
                                        ...
                                        <td style=" text-align: center;">
                                            ...
                                            <td style=" text-align: center;">
                                                {{ $alislardataitem->miktar }} Adet</td>
                                                @else
                                                <td style=" text-align: center;">
                                                    {{ $alislardataitem->miktar }} {{ $alislardataitem->birim }}</td>
                                            @endif

                                            <td style=" text-align: center;"> {{  number_format($alislardataitem->birim_fiyat, 2, ',', '.') }} ₺</td>
                                        <td style=" text-align: center;">{{ number_format($alislardataitem->ara_toplam, 2, ',', '.') }} ₺</td>
                                        <td style=" text-align: center;">%{{ $alislardataitem->kdv_oran }}
                                        </td>
                                        <td style=" text-align: center;">{{number_format( $alislardataitem->kdv_tutar, 2, ',', '.') }} ₺
                                        </td>
                                        <td style=" text-align: center;">{{ number_format($alislardataitem->iskonto, 2, ',', '.') }} ₺
                                        </td>
                                        <td style=" text-align: center;">{{ number_format( $alislardataitem->tutar, 2, ',', '.') }}
                                            ₺</td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <div class="col-md-12">
                                <table class="total-table">
                                    <tr>
                                        ...
                                        <td>{{ number_format($alislar->toplam_iskonto, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>TOPLAM KDV</th>
                                        <td>{{ number_format($alislar->toplam_kdv_tutar, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>ARA TOPLAM</th>
                                        <td>{{ number_format($alislar->toplam_ara_toplam, 2, ',', '.') }} ₺</td>
                                    </tr>
                                    <tr>
                                        <th>TOPLAM TUTAR</th>
                                        <td>{{ number_format($alislar->toplam_tutar, 2, ',', '.') }} ₺</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
