     ...
     public function handle()
     {
         try {
             ...
             if (!$response || !is_array($response)) {
                 $this->error('Fatura verileri alınamadı.');
                 Commandslog::create([
                     'command_name' => 'gelenefatura:aktar',
                     'status' => 'error',
                     'message' => 'Fatura verileri alınamadı',
                     'context' => json_encode([]),
                     'logged_at' => now(),
                 ]);
                 return;
             ...
             Commandslog::create([
                 'command_name' => 'gelenefatura:aktar',
                 'status' => 'success',
                 'message' => 'Tüm faturalar başarıyla kaydedildi.',
                 'context' => null,
                 'logged_at' => now(),
             ]);
         } catch (\Exception $e) {
             $this->error('İşlem sırasında hata oluştu.');
             Commandslog::create([
                 'command_name' => 'gelenefatura:aktar',
                 'status' => 'fatal_error',
                 'message' => $e->getMessage(),
