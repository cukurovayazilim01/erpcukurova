...
return new class extends Migration
{
    ...
    {
        Schema::create('gidenefaturadatas', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('gidenefatura_id')->nullable();
            $table->foreign('gidenefatura_id')->references('id')->on('gidenefaturalars')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('gidenefaturadatas');
    }
};
