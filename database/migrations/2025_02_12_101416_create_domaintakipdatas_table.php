...
return new class extends Migration
{
    ...
    {
        Schema::create('domaintakipdatas', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('domaintakip_id')->nullable();
            $table->foreign('domaintakip_id')->references('id')->on('domaintakips')->onDelete('cascade');
            $table->date('tarih')->nullable();
            $table->longText('domain_suresi')->nullable();
            ...
            $table->longText('hosting_platform_iki')->nullable();
    ...
    {
        Schema::dropIfExists('domaintakipdatas');
    }
};
